import { MarkdownEntry, MarkdownSection } from "@type/markdown-entry";
...
export const paladinLevel3Section: MarkdownSection = {
  title: "Paladin Features (Level 3)",
  sections: [paladinLevel3Entries],
};
...
export const paladinSubclassLevel3Entries: MarkdownEntry = [
  [
    {
      width: "60%",
      markdown: `Oath Spells - 3rd level
...
export const paladinOathOfGlorySubClassSection: MarkdownSection = {
  title: "Oath of Glory Features",
  sections: paladinSubclassLevel3Entries,
};
