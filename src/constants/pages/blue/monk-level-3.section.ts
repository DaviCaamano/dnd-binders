...
export const monkClassLevel3Section: MarkdownSection = {
  title: "Monk Features",
  sections: [monkSubclassLevel3Entries],
};

const monkSubclassEntries = `
### Draconic Presence - 3rd level
...
export const monkSubclassSections: MarkdownSection = {
  title: "Way of the Ascendant Dragon Features",
  sections: [monkSubclassEntries],
};
